...
try:
    ...
    query_pedidoComp = """ select c.nome_cliente, (s.descricao)serviço, m.os, o.placa, orc.honorarios, (orc.vistoria)validacao,
 (orc.extras)Reembolso, m.observacao, orc.ipva_total, orc.prim_parcela, orc.seg_parcela,
