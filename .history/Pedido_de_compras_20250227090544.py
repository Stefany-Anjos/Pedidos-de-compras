...
# Iterar sobre as colunas da planilha
for col in range(sheet.max_column, 0, -1):  # Começa da última coluna e vai até a primeira
    # Verificar se todos os valores da coluna (exceto o cabeçalho) são 0
    all_zero = True
    ...
    if all_zero:
        sheet.delete_cols(col)  # Exclui a coluna se todos os valores forem 0
wb.save(caminho_completo)