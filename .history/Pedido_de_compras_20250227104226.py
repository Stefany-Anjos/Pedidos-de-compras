...
#                                     ENVIAR EMAIL
imagem_path = r'M:\TI\ROBOS\ROBOS PYTHON\MULTAS\Robo colar comprovantes\logo.png'
...
# Exibir a imagem codificada em base64
print(imagem_base64)
...
with open(caminho_completo, 'rb') as anexo:
    ...
    part.add_header(
        'Content-Disposition',
        f'attachment; filename="Pedido de com.xlsx"'
    )
    msg.attach(part)
