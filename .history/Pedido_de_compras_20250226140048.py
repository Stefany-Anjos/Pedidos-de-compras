...
try:
    ...
    query_pedidoComp = """ select c.nome_cliente, (s.descricao)serviço, m.os, o.placa, orc.honorarios, orc.taxa_detran, (orc.vistoria)validacao, orc.vlr_correio, (cp.ipva)ipva_cp, (cp.licenciamento)lic_cp, (cp.multas)multas_cp, codigo_cp, (orc.extras)Reembolso, m.observacao, m.solicitante
from os o
