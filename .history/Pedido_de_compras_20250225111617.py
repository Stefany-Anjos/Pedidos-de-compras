...
for col, valor in enumerate(cabecalho, start=1):
    aba.cell(row=1, column=col, value=valor)

# Adicionar cor de fundo e estilo ao cabeçalho (linha 1)
cor_fundo = PatternFill(start_color="FFFF00", end_color="FFFF00", fill_type="solid")  # Amarelo
...
for linha in ws.iter_rows(min_row=1, min_col=9, max_col=9):
    for celula in linha:
         ...
         if isinstance(valor, str) and "CP" in valor:
            ...
            print(valor_limpo)  # Exibe o valor após a remoção do texto
