...
orc.placas_esp, orc.licenciamento, orc.multas, orc.vlr_bo, orc.total, orc.txvistoriamovel, (cp.ipva)ipva_cp, (cp.licenciamento)lic_cp, (cp.multas)multas_cp, codigo_cp, (orc.extras)Reembolso, m.solicitante
from os o
